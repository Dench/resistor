...
<div class="sale-form">
    ...
    <?php if ($model->id): ?>
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title"><?= Yii::t('app', 'Photos') ?></h4>
            </div>
            <div class="box-body">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title"><?= Yii::t('app', 'General Info') ?></h4>
                </div>
                <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"><?= Yii::t('app', 'Location') ?></h4>
                        </div>
                        <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    $form->field($model, 'district_id')->widget(DepDrop::classname(), [
                                        ...
                                        'pluginOptions' => [
                                            'depends' => ['region_id'],
                                            'placeholder' => false,
                                            'url' => Url::to(['/personal/district-list']),
                                        ],
                                        /*'pluginEvents' => [
                ...
                <div class="col-md-4">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"><?= Yii::t('app', 'Extra') ?></h4>
                        </div>
                        <div class="box-body">
        ...
        <div class="col-xs-6 col-md-4">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title"><?= Yii::t('app', 'Description (visible)') ?></h4>
                </div>
                <div class="box-body">
                    <?php
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title"><?= Yii::t('app', 'Notes') ?></h4>
                </div>
                <div class="box-body">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title"><?= Yii::t('app', 'Contact Info') ?></h4>
                </div>
                <div class="box-body">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title"><?= Yii::t('app', 'Add Attachments') ?></h4>
                </div>
                <div class="box-body">
                    <?php
                        $preview = [];
